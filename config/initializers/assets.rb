...
Rails.application.config.assets.precompile += %w( admin_page.css )
Rails.application.config.assets.precompile += %w( members.css )
Rails.application.config.assets.precompile += %w( points.css )
Rails.application.config.assets.precompile += %w( newsfeeds.css )
